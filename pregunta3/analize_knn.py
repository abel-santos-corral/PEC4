...
print("\033[34mEjecutando...\033[0m \033[33manalize_knn\033[0m")

# Crear carpetas necesarias
os.makedirs("pregunta3/imagenes/knn", exist_ok=True)
...
for sample_size in sample_sizes:
    ...
    for k in k_values:
        ...
        plt.tight_layout()
        plt.savefig(f"pregunta3/imagenes/knn/muestra_{sample_size}_k_{k}_petal.png")
        plt.close()
        ...
        plt.legend(fontsize='small', loc='best')
        plt.tight_layout()
        plt.savefig(f"pregunta3/imagenes/knn/muestra_{sample_size}_k_{k}_sepal.png")
        plt.close()

# Imprimir feedback por pantalla:
print("\033[34mFinalizado...\033[0m \033[33manalize_knn\033[0m")
